...
;;compare two images and produce the taller one




;(define (taller-image) (rectangle 5 5 "solid" "red")) ;stub
;;
...
(check-expect (taller-image (rectangle 30 20 "solid" "red")
                            (rectangle 20 30 "solid" "red"))
              (rectangle 20 30 "solid" "red"))
(check-expect (taller-image (rectangle 30 30 "solid" "red")
