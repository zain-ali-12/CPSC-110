...
(check-expect (render-ball (make-ball 40 30 3 3))
              (place-image BALL
                           (+ 30 TOP)
                           (+ 40 LEF)
                           MTS))
(check-expect (render-ball (make-ball TOP LEF 2 2))
              (place-image BALL
                           TOP
                           LEF
                           MTS))
(check-expect (render-ball (make-ball TOP RIG 2 2))
              (place-image BALL
                           TOP
                           (- RIG 10)
                           MTS))
(check-expect (render-ball (make-ball BOT RIG 2 2))
              (place-image BALL
                           BOT
                           RIG
                           MTS))
(check-expect (render-ball (make-ball BOT LEF 2 2))
              (place-image BALL
                           BOT
                           LEF
                           MTS))
