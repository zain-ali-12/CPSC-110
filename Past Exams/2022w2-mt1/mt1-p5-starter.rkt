...
- You must not edit any parts of the file other than the function
  definition for render and the check-expects for tock.  This means
  you may not comment out, or in any other way edit other parts of 
  file. Any edits to any other part of the file will result in 0 
  marks for the entire file. If you have to submit a failing test
  then go ahead and do so, you may still get partial credit. If
  you comment out a failing test you will get 0 marks.
...
;; **** PART A ****
;;
;; Complete the design of the render function by commenting out the stub and
;; then adding a complete and correct render function definition. The provided
;; function check-expects are valid. Again, you MUST NOT edit any part of this
;; function design except to add a complete function definition.
;;
