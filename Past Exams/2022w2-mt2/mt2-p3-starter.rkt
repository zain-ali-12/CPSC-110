...
#reader(lib "htdp-intermediate-reader.ss" "lang")((modname mt2-p3-starter) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #t)))
...
To solve this problem you must consult the figure in mt2-p3-figure.pdf.  In that
figure you will see part of the solution to problem set 4.  On that solution we
have marked 6 boxes (A through F) selecting some part of the program.  For each
of those boxes you must choose the correct technical term below.
...
NOTE: This problem will be autograded, and ALL OF THE FOLLOWING ARE ESSENTIAL
 ...
 - You MUST NOT EDIT any part of this file other than the values for the
   constants BOX-A through BOX-F below.
...
For each of the constants BOX-A through BOX-F, you must replace "???" with ONE
of the technical term strings below.  It is VERY important to note that:
  
  - most technical terms will not be used, since there are only 6 boxes
