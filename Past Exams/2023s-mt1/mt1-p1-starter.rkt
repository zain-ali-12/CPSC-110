...
(@cwl sali34)   ;fill in your CWL here (same as for problem sets)
...
figure you will see part of the solution to problem set 3.  On that solution we
...
NOTE: This problem will be autograded, and ALL OF THE FOLLOWING ARE ESSENTIAL
 ...
 - Your submission WILL NOT BE GRADED if running it produces red errors or
   if it fails the Check Syntax button.
