...
#reader(lib "htdp-beginner-abbr-reader.ss" "lang")((modname mt2-p2-starter) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
(require spd/tags)
...
To solve this problem you must consult the figure in mt2-p2-figure.pdf.  In the
code shown in the figure there are six marked boxes (A through F) selecting some
part of the program.  For each of those boxes you must choose the correct
technical term below.
