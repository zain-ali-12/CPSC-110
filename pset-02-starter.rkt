...
;;produce true if preference is 1 or 5
...
;;produce true if altitude is a number and false otherwise

(check-expect (inflight? A0) false)
(check-expect (inflight? A1) true)
(check-expect (inflight? A2) false)
